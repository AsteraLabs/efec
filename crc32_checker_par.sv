...
//   Init      : 0x00000000  (pre-inversion) (Vlad modified from 0xFFFFFFFF, the customer wants zero CRC on zero data))
//   Final XOR : 0x00000000  (post-inversion) (Vlad modified from 0xFFFFFFFF, the customer wants zero CRC on zero data))
...
//   identical to the crc32_Koopman_enc.sv feedback (design log sec. 10.4).
//
